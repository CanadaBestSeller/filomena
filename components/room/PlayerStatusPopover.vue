<template>
  <div class="my-1 text-center m-0">
    ...
    <b-popover class="shadow" target="popover-target" triggers="hover" placement="bottom">
      <b-list-group v-for="player in f.roomDoc.players" :key="player.uid" class="mt-2 mb-1 mx-0 text-center">
        <b-list-group-item class="d-flex flex-row p-1 m-0 align-items-center border-0">
          ...
          <b-badge class="ml-auto" pill variant="primary">{{ player.points }}</b-badge>
        </b-list-group-item>
      </b-list-group>
    </b-popover>
